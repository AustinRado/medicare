...
const DoctorCard = ({doctor}) => {
  ...
  return (
    <div className="p-3 lg:p-5">
        <div>
            <img src={photo} className="w-full image-container" alt="Doctor images"/>
        </div>
        ...
        <div className='mt-2 lg:mt-4 flex items-center justify-between'>
            ...
            <div className='flex items-center gap-[6px]'>
                <span className='flex items-center gap-[6px] text-[14px] leading-6 lg:text-[16px] lg:leading-7 font-semibold text-headingColor'>
                    <img src={star} className='w-[10px] h-1/4 pb-[2px]' alt='star icon'/>{avgRating}
                </span>
        ...
        <div className='mt-[18px] lg:mt-5 flex items-center justify-between'>
            ...
            <Link to='/doctors/1' className='w-[44px] h-[44px] rounded-full boarder boarder-solid border-[#181A1E] flex items-center justify-center group hover:bg-primaryColor hover:border-none'>
