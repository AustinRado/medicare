      ...
      <div className='container'>
          ...
          <div className='rounded-l-lg lg:pl-16 py-10'>
            ...
            <form onSubmit={submitHandler} className='py-4 md:py-0'>
              ...
              <input
                className='w-full pr-5 py-3 border-b border-solid border-[#0066ff61] focus:outline-none focus:border-b-primaryColor text-[16px] leading-7 text-headingColor placeholder:text-textColor cursor-pointer'
                type='text'
            ...
            <button
              ...
              type='submit'
            >
            {isLoading ? <HashLoader size={35} color='#ffffff'/> : "Sign up"}
            </button>
          </div>
