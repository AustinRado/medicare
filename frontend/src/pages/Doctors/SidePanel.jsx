  ...
  return (
    <div className='shadow-panelShadow p-3 lg:p-5 rounded:md'>
        <div className='flex items-center justify-between'>
          ...
          <span className='text-[16px] leading-7 lg:text-[22px] lg:leading-8 text-headingColor font-bold'>Kshs. 2,500</span>
        </div>
        <div className='mt-4'>
         ...
         <ul className='mt-3'>
           <li className='flex items-center justify-between mb-2'>
             ...
             <p className='text-[15px] leading-6 text-textColor font-semibold'>16:00Hrs - 21:00Hrs</p>
           </li>
           <li className='flex items-center justify-between mb-2'>
             <p className='text-[15px] leading-6 text-textColor font-semibold'>Tuesday</p>
             <p className='text-[15px] leading-6 text-textColor font-semibold'>08:00Hrs - 18:00Hrs</p>
           </li>
           <li className='flex items-center justify-between mb-2'>
